...
/**
 * Test utils for FreshAgent provisioner
 */
public class FreshAgentProvisionerTestUtils {

  public static void setupFreshAgentExternalSystem() {
    ...
    new GrouperDbConfig().configFileName("grouper-loader.properties").propertyName("grouper.wsBearerToken.freshServiceDev.endpoint")
        .value((ssl ? "https://" : "http://") + domainName + ":" + port + "/grouper/mockServices/freshAgent").store();
    ...
    new GrouperDbConfig().configFileName("grouper-loader.properties").propertyName("grouper.wsBearerToken.freshServiceDev.testUrlSuffix").value("/api/v2/agents").store();
    new GrouperDbConfig().configFileName("grouper-loader.properties").propertyName("grouper.wsBearerToken.freshServiceDev.testUrlResponseBodyRegex").value(".*agents.*").store();

    new GrouperDbConfig().configFileName("grouper.properties").propertyName("grouperTest.exampleFreshAgent.mockExternalSystem.configId").value("freshServiceDev").store();
  }
   ...
   * @param value
   */
  public static void configureProvisionerSuffix(FreshAgentProvisionerTestConfigInput provisioningTestConfigInput, String suffix, String value) {
  ...
  private static void configureProvisioner(FreshAgentProvisionerTestConfigInput provisioningTestConfigInput) {
    ...
    configureProvisionerSuffix(provisioningTestConfigInput, "class", FreshAgentProvisioner.class.getName());
   ...
   * @param provisioningTestConfigInput
   */
  public static void configureFreshAgentProvisioner(FreshAgentProvisionerTestConfigInput provisioningTestConfigInput) {
