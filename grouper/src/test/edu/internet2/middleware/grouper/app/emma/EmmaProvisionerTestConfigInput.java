...
/**
 * Config input for Emma provisioner tests
 */
public class EmmaProvisionerTestConfigInput {
   ...
   */
  public EmmaProvisionerTestConfigInput assignConfigId(String string) {
   ...
   * @return this for chaining
   */
  public EmmaProvisionerTestConfigInput assignProvisioningStrategy(String provisioningStrategy) {
   ...
   * @return this for chaining
   */
  public EmmaProvisionerTestConfigInput assignGroupOfUsersToProvision(Group groupOfUsersToProvision) {
