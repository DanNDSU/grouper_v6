...
/**
 * Config input for FreshAgent provisioner tests
 */
public class FreshAgentProvisionerTestConfigInput {
   ...
   */
  public FreshAgentProvisionerTestConfigInput assignConfigId(String string) {
   ...
   * @return this for chaining
   */
  public FreshAgentProvisionerTestConfigInput assignProvisioningStrategy(String provisioningStrategy) {
   ...
   * @return this for chaining
   */
  public FreshAgentProvisionerTestConfigInput addExtraConfig(String suffix, String value) {
   ...
   * @return this for chaining
   */
  public FreshAgentProvisionerTestConfigInput assignGroupOfUsersToProvision(Group groupOfUsersToProvision) {
