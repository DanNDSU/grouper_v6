...
public class FreshAgentMembership {
  ...
  public static void createTableFreshMembership(DdlVersionBean ddlVersionBean, Database database) {
    ...
    final String tableName = "mock_freshagent_membership";
    ...
    try {
      ...
      GrouperDdlUtils.ddlutilsFindOrCreateIndex(database, tableName, "mock_freshagent_mship_gid_idx", false, "group_id");
      GrouperDdlUtils.ddlutilsFindOrCreateIndex(database, tableName, "mock_freshagent_mship_uid_idx", false, "user_id");
      GrouperDdlUtils.ddlutilsFindOrCreateIndex(database, tableName, "mock_freshagent_mship_uid_idx", true, "group_id", "user_id");
      
      GrouperDdlUtils.ddlutilsFindOrCreateForeignKey(database, tableName, "mock_freshagent_mship_gid_fkey", "mock_freshagent_group", "group_id", "id");
      GrouperDdlUtils.ddlutilsFindOrCreateForeignKey(database, tableName, "mock_freshagent_mship_uid_fkey", "mock_freshagent_user", "user_id", "id");
    }
